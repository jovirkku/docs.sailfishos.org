...
* Adding the Google account to your device is described in [this document](/Support/Help_Articles/Accounts_Setup/Setup_Google_Account)
* Nextcloud ("Settings > Accounts > Add account > Nextcloud")

# Install Android app store(s)

The Sailfish OS operating system of Jolla supports Android apps that are featured in the Jolla Store and in Jolla-certified app partner stores. More information can be found in [this document](/Support/Help_Articles/Android_App_Support/#installing-applications-from-application-stores). Note that "Settings > Untrusted software" needs to be enabled before installing the stores or apps.
